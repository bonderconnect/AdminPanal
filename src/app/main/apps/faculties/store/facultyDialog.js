...
export const createFaculty = createAsyncThunk(
	'facultiesApp/facultyDialog/createFaculty',
...
export const updateFaculty = createAsyncThunk(
	'facultiesApp/facultyDialog/updateFaculty',
	async (payload, { dispatch, getState, rejectWithValue }) => {
		const { form } = payload;
		const { userId } = getState().facultiesApp.facultyDialog.data;
...
export const openEditFacultyDialog = createAsyncThunk(
	'facultiesApp/facultyDialog/openEditFacultyDialog',
	async userId => {
...
const facultyDialogueSlice = createSlice({
	name: 'facultiesApp/facultyDialog',
	initialState,
	reducers: {
	...
	extraReducers: {
		...
		[openEditFacultyDialog.pending]: (state, action) => {
		...
		[openEditFacultyDialog.fulfilled]: (state, action) => {
...
export const { openNewFacultyDialog, closeDialog } = facultyDialogueSlice.actions;

export default facultyDialogueSlice.reducer;
