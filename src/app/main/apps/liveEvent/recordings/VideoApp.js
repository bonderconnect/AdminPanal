...
import { getCategories } from '../store/recordings/categorySlice';
import { getPackages } from '../store/recordings/packageSlice';
...
export default withReducer('liveEventApp', reducer)(VideoApp);
