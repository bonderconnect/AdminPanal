...
import { closeVideoPreview } from '../store/recordings/videoPreviewSlice';
...
function VideoPreviewDialogue(props) {
	...
	const { dialogue, video, loading } = useSelector(({ liveEventApp }) => liveEventApp.recordings.videoPreview);
