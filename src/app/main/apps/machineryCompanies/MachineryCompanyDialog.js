...
import { closeDialog, createMachineryCompany, updateMachineryCompany } from './store/machineryCompanyDialog';
import { getMachineryCompanies } from './store/machineryCompanies';

function MachineryCompanyDialog(props) {
	...
	const {
		...
		errors: storeErrors
	} = useSelector(({ machineryCompaniesApp }) => machineryCompaniesApp.machineryCompanyDialog);
	...
	const callback = () => {
		...
		dispatch(getMachineryCompanies());
	};

	const onSubmit = (data, e) => {
		if (type === 'new') {
			dispatch(createMachineryCompany({ form: data, callback }));
		} else {
			dispatch(updateMachineryCompany({ form: data, callback }));
		}
	};
	...
	return (
		<Dialog
			fullWidth
			maxWidth="xs"
			aria-labelledby="new-machineryCompany-dialog-title"
			open={open}
			onClose={handleClose}
		>
			<DialogTitle id="new-machineryCompany-dialog-title" onClose={handleClose}>
...
export default MachineryCompanyDialog;
