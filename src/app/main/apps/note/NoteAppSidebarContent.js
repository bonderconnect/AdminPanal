...
import { openNewNoteDialog } from './store/noteDialogueSlice';
import { setNotesParams } from './store/notesSlice';
import { selectPackages } from './store/packageSlice';
import NoteAppSidebarCategories from './NoteAppSidebarCategories';
...
function MailAppSidebarContent(props) {
	...
	const { params } = useSelector(({ noteApp }) => noteApp.notes);
	...
	const handleCategoryChange = categoryId => {
		setTimeout(() => {
			...
			dispatch(setNotesParams(updatedParams));
		}, 0);
	};
	...
	return (
		<div className="flex-auto border-l-1">
			...
			<div className="px-24">
				...
				<NoteAppSidebarCategories setCategory={handleCategoryChange} />
