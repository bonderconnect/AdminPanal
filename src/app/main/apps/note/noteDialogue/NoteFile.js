...
const NoteFile = forwardRef((props, ref) => {
	const classes = useStyles();
	const { file, setFile, noteDialogueUploadInProgress, error } = props;
					...
					<div className={clsx('flex', 'flex-col', 'flex-1')}>
						<div className={clsx(classes.root, props.className, 'mt-12', 'py-12', 'mb-2', 'flex-1')}>
							...
							<IconButton
								className={clsx(
									'ml-12',
									noteDialogueUploadInProgress && 'pointer-events-none',
									noteDialogueUploadInProgress && 'invisible'
								)}
