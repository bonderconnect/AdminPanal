...
import { selectProducts, getProducts, setParams } from '../store/products';
import { openEditProductDialog } from '../store/productDialog';
...
function ProductsContent() {
	...
	const { params, loading, meta } = useSelector(({ productsApp }) => productsApp.products);
	...
	const columns = useMemo(
		() => [
			...
			{
				Header: 'Product meta details',
				id: 'product_meta_details',
						...
						<div className="flex items-center align-center">
							<Button
								onClick={ev => {
									...
									dispatch(openEditProductDialog(row?.original?.created_user_id));
								}}
								variant="contained"
								size="small"
								color="primary"
											...
											children: (
												<>
													...
													<DialogActions>
														...
														<Button
															onClick={() => {
																// dispatch(removeUser(row.original.created_user_id));
