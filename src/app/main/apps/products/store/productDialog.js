...
export const createProduct = createAsyncThunk(
	'productsApp/productDialog/createProduct',
...
export const updateProduct = createAsyncThunk(
	'productsApp/productDialog/updateProduct',
	async (payload, { dispatch, getState, rejectWithValue }) => {
		const { form } = payload;
		const { userId } = getState().productsApp.productDialog.data;
...
export const openEditProductDialog = createAsyncThunk(
	'productsApp/productDialog/openEditProductDialog',
	async userId => {
...
const productDialogueSlice = createSlice({
	name: 'productsApp/productDialog',
	initialState,
	reducers: {
	...
	extraReducers: {
		...
		[openEditProductDialog.pending]: (state, action) => {
		...
		[openEditProductDialog.fulfilled]: (state, action) => {
...
export const { openNewProductDialog, closeDialog } = productDialogueSlice.actions;

export default productDialogueSlice.reducer;
