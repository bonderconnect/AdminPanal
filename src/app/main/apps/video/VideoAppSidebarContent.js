...
import { openNewVideoDialog } from './store/videoDialogueSlice';
import { setVideosParams } from './store/videosSlice';
...
function VideoAppSidebarContent(props) {
	...
	const { params } = useSelector(({ videoApp }) => videoApp.videos);
	const packages = useSelector(selectPackages);
	const { t } = useTranslation('videoApp');
