...
import { getVideo, reset as resetVideoDetail } from '../store/video/detail';
import { reset as resetVideoWatchLogs } from '../store/video/watchLogs';
...
function Video() {
	...
	const { data: video } = useSelector(state => state.videoApp.video.detail);
